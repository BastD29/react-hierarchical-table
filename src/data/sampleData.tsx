type SampleSubtask = {
  ...
  endDate: Date;
  duration: number;
  progress: number | string; // Progress can be a number or string (like "50")
  priority: string;
  approved: boolean;
  subtasks?: SampleSubtask[]; // Optional for nested subtasks
};
...
type SampleData = {
  ...
  priority: string;
  approved: boolean;
  subtasks?: SampleSubtask[]; // Optional because there might not be subtasks
};

// export let sampleData: Object[] = [
export let sampleData: SampleData[] = [
  {
    taskID: 1,
    taskName: "Planning",
